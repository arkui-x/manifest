...
开源代码仓库地址：[https://gitcode.com/arkui-x](https://gitcode.com/arkui-x)。

## 前提条件

1. 注册码云gitee账号。

2. 注册码云SSH公钥，请参考[GitCode帮助中心](https://docs.gitcode.com/docs/help/home/user_center/security_management/ssh)。
...
- **ArkUI-X开发分支代码获取**
  ...
  mkdir arkui
  cd arkui
  repo init -u git@gitcode.com:arkui-x/manifest.git -b master --no-repo-verify -m arkui-dev.xml
  repo sync -c --no-tags -j12
  ```
  ...
  mkdir arkui
  cd arkui
  repo init -u https://gitcode.com/arkui-x/manifest.git -b master --no-repo-verify -m arkui-dev.xml
  repo sync -c --no-tags -j12
  ```
...
| developtools/ace_tools                    | 跨平台应用构建命令行工具                                      | [ArkUI-X/cli](https://gitcode.com/arkui-x/cli) |
...
| foundation/arkui/ace_engine                 | ArkUI引擎核心代码 | [OpenHarmony/arkui_ace_engine](https://gitcode.com/openharmony/arkui_ace_engine) |
...
| commonlibrary/c_utils                              | C++公共基础类库                                          | [OpenHarmony/commonlibrary_c_utils](https://gitcode.com/openharmony/commonlibrary_c_utils) |
...
| test/xts               | ArkUI-X应用测试套件      | [ArkUI-X/xts](https://gitcode.com/arkui-x/xts) |
| test/testfwk/arkxtest                | ArkUI-X测试框架       | [ArkUI-X/arkxtest](https://gitcode.com/arkui-x/arkxtest) |
| interface/sdk                | ArkUI-X SDK相关配置       | [ArkUI-X/interface_sdk](https://gitcode.com/arkui-x/interface_sdk) |
| productdefine/common               | ArkUI-X产品形态定义       | [ArkUI-X/productdefine](https://gitcode.com/arkui-x/productdefine) |
